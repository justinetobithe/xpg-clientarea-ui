            ...
            <div className="relative">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                    {visible.map((a) => {
                        ...
                        return (
                            <div key={a.id} className="rounded-xl overflow-hidden shadow-xl bg-gray-900 border border-white/10 hover:border-orange-400 transition duration-300">
                                ...
                                <div className="p-4">
                                    <h3
                                        title={a.title}
                                        className="text-white font-extrabold text-base leading-snug truncate mb-1"
                                    >
                                        {a.title || "Untitled"}
                                    </h3>
